...
for i in range(int(t/dt)):
       ...
       if z3[i]>=0:
          ...
          break
ax.plot(x3,y3,z3,color='r',label='With Air Drag and Topspin')      
x1=[0]
y1=[0]
z1=[0]
vx1=[30]
...
for i in range(int(t/dt)):
       ...
       if z1[i]>=0:
          ...
          break
ax.plot(x1,y1,z1,color='g',label='with AirDrag but no  Spin') 
x2=[0]
y2=[0]
z2=[0]
vx2=[30]
...
for i in range(int(t/dt)):
       ...
       if z2[i]>=0:
          ...
          break
ax.plot(x2,y2,z2,color='k',label='With Air Drag and Backspin')      
